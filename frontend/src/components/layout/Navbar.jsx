...
import { Send, ShoppingBag, ShieldCheck } from "lucide-react";
import { Button } from "@/components/ui/button";
import { AmazonPill } from "@/components/ui/AmazonBuyButton";
    ...
    return (
        <header className="sticky top-0 z-50 w-full glass-header transition-all duration-300">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
                ...
                {/* Right Action: Amazon, Warranty, Shopping Bag & Direct Inquiry CTAs */}
                <div className="flex items-center gap-2.5">
                    <AmazonPill />

                    <Link
                        to="/warranty"
                        className="hidden lg:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/15 text-slate-200 hover:text-white text-xs font-bold transition-all"
                    >
