...
import { ArrowRight, ArrowUpRight, Send, Loader2, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function HeroBanner() {
    ...
    if (loading) {
        return (
            <section className="bg-[#050507] min-h-[60vh] flex items-center justify-center">
                <div className="flex items-center gap-3 text-slate-400">
                    <Loader2 className="w-5 h-5 animate-spin text-[#F27E24]" />
