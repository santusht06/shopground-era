                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="text-center space-y-3 max-w-2xl mx-auto">
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed font-normal">
                            Submit your details below. Your inquiry will be logged directly into our database and routed immediately to our sales management team (<span className="font-bold text-[#F27E24]">employee.sales@shopground.era</span>).
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center gap-2 text-xs text-slate-400">
                                ...
                                <span>SSL Encrypted — Dispatches immediately to employee.sales@shopground.era</span>
                            </div>
