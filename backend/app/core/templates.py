# ShopGround Era Transactional Email Templates (Rich Dark & 100% Consistent Across Light/Dark Modes)
...
<head>
  ...
  <style>
    ...
    @media (prefers-color-scheme: light) {{
      .bg-main {{ background-color: #050507 !important; }}
      .bg-card {{ background-color: #0c0c12 !important; color: #ffffff !important; }}
      .text-white {{ color: #ffffff !important; }}
    }}
  </style>
</head>
<body id="body" style="margin: 0; padding: 0; background-color: #050507; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #ffffff; -webkit-text-size-adjust: 100%;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" class="bg-main" style="background-color: #050507; padding: 40px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" class="bg-card" style="max-width: 580px; background-color: #0c0c12; border: 1px solid #1e1e2d; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.8);">
          <!-- Header Banner -->
          <tr>
            <td style="background: linear-gradient(135deg, #141420 0%, #0c0c12 100%); padding: 32px 32px 24px; text-align: center; border-bottom: 1px solid #1a1a29;">
              <img src="https://shopgroundera.com/logo.png" alt="ShopGround Era" style="height: 48px; width: auto; margin-bottom: 12px; display: inline-block;" />
              <h1 class="text-white" style="color: #ffffff; font-size: 22px; font-weight: 800; margin: 0; letter-spacing: -0.5px;">Lifetime Guarantee Active</h1>
              <p style="color: #f27e24; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin: 6px 0 0 0;">100-Year Guarantee Protection</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px;">
              <p class="text-white" style="color: #e4e4e7; font-size: 15px; line-height: 1.6; margin: 0 0 20px 0;">Dear <strong>{customer_name}</strong>,</p>
                ...
                <tr>
                  <td>
                    <table role="presentation" width="100%" style="font-size: 13px; color: #d4d4d8;">
                      ...
                      <tr>
                        <td style="padding: 8px 0 0 0; color: #71717a; border-top: 1px dashed #27273a;">Guarantee Status:</td>
                        <td style="padding: 8px 0 0 0; text-align: right; font-weight: 700; color: #22c55e; border-top: 1px dashed #27273a;">LIFETIME GUARANTEE ACTIVE</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <p style="color: #71717a; font-size: 12px; line-height: 1.5; text-align: center; margin: 28px 0 0 0;">
                If you ever experience vibration dampening failure or defect, file a claim anytime at <a href="https://shopgroundera.com/warranty" style="color: #f27e24; text-decoration: underline;">shopgroundera.com/warranty</a>.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #08080e; padding: 20px; text-align: center; border-top: 1px solid #181824;">
              <p style="color: #71717a; font-size: 12px; margin: 0;">&copy; 2026 ShopGround Era Inc. All rights reserved.</p>
              <p style="color: #52525b; font-size: 11px; margin: 4px 0 0 0;">Official Guarantee Portal &bull; info@shopgroundera.com</p>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td align="center">
        <table role="presentation" width="100%" class="bg-card" style="max-width: 580px; background-color: #0c0c12; border: 1px solid #1e1e2d; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.8);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #141420 0%, #0c0c12 100%); padding: 32px 32px 24px; text-align: center; border-bottom: 1px solid #1a1a29;">
              <img src="https://shopgroundera.com/logo.png" alt="ShopGround Era" style="height: 48px; width: auto; margin-bottom: 12px; display: inline-block;" />
              <h1 class="text-white" style="color: #ffffff; font-size: 22px; font-weight: 800; margin: 0; letter-spacing: -0.5px;">Defect Claim Received</h1>
          ...
          <tr>
            <td style="padding: 32px;">
              <p class="text-white" style="color: #e4e4e7; font-size: 15px; line-height: 1.6; margin: 0 0 20px 0;">Dear <strong>{customer_name}</strong>,</p>
              <p style="color: #a1a1aa; font-size: 14px; line-height: 1.6; margin: 0 0 24px 0;">
                We have received your defect claim for Warranty Code <strong style="color: #f27e24;">{warranty_code}</strong>. Our Quality Engineering team has initiated an audit of your report and attached media evidence.
              </p>
              ...
              <p style="color: #71717a; font-size: 12px; line-height: 1.5; text-align: center; margin: 28px 0 0 0;">
                You will receive an automated notification as soon as our Quality Engineers authorize replacement dispatch.
              </p>
            </td>
          </tr>
      ...
      <td align="center">
        <table role="presentation" width="100%" class="bg-card" style="max-width: 580px; background-color: #0c0c12; border: 1px solid #1e1e2d; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.8);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #141420 0%, #0c0c12 100%); padding: 32px 32px 24px; text-align: center; border-bottom: 1px solid #1a1a29;">
              <img src="https://shopgroundera.com/logo.png" alt="ShopGround Era" style="height: 48px; width: auto; margin-bottom: 12px; display: inline-block;" />
              <h1 class="text-white" style="color: #ffffff; font-size: 22px; font-weight: 800; margin: 0; letter-spacing: -0.5px;">Claim Decision Update</h1>
